class Alumno {
  ...
  factory Alumno.fromMap(Map<String, dynamic> m) => Alumno(
    id: m['id'],
    nombre: m['nombre'],
    telefono: m['telefono'],
    fechaInscripcion: DateTime.parse(m['fecha_inscripcion']),
    fechaVencimiento: DateTime.parse(m['fecha_vencimiento']),
